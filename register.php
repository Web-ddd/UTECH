...
<body data-spy="scroll" data-offset="60">
    ...
    <div class="w3-display-middle top-content">
        ...
        <div class="inner-bg">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-12 col-md-offset-0 form-box" style="height: 520px;">
                        <div class="form-top">
                        ...
                        <div class="form-bottom">
                            <form class="material">
                                ...
                                <h3 class="register">لديك حساب فعلا ؟ <a href="login.php">سجل دخولك</a></h3>
